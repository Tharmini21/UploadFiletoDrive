/**
 * @file plugins.js
 * @name cloudwave_save_attachmentto_drive
 * @description Plugin to integrate Smartsheet Attachment to Google 
 * Drive 
 *
...
/**
 * cloudwave_save_attachmentto_drive plugin. To be used with
 ...
 *    converseai.cloudwave_save_attachmentto_drive(req, res);
 * });
 *
 * @param {Object} request Express HTTP request object.
 * @param {Object} response Express HTTP response object.
 */
exports.cloudwave_save_attachmentto_drive = function (request, response) {
  ...
  if (request && request.headers && request.headers['x_converse_app_token'] && request.headers['x_converse_app_token'] === require('./app-token')) {
    ...
    app.setModules({
      save_attachmentto_drive: require('./converseai_modules/save_attachmentto_drive')
    });
